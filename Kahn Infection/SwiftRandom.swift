...
// Copied from http://stackoverflow.com/a/25129039/159801
...
extension UIColor {
	class func randomColor() -> UIColor {
		// random but not too dark

		return UIColor(hue: CGFloat(Int.random(lower:0)) / CGFloat(Int.max), saturation: CGFloat(Int.random(lower:0)) / CGFloat(Int.max), brightness: CGFloat(Int.random(lower:Int.max/2)) / CGFloat(Int.max), alpha: 1)
	}
}
